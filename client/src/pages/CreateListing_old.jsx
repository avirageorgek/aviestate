            ...
            (async () => {
                if(listId) {
                    ...
                    if(result.success) {
                        ...
                        console.log("Image Urls: ", result.data.imageUrls);
        ...
        <main className="mx-auto max-w-4xl p-3 mt-7">
            ...
            <form className="w-full flex flex-col sm:flex-row gap-4" onSubmit={formik.handleSubmit}>
                <div className="flex flex-col gap-4 flex-1">
                    <div className="flex flex-wrap mb-2">
                        <div className="w-full px-3 mb-6 md:mb-0">
                            ...
                            defaultValue={(currentListing && currentListing.name) ? currentListing.name : formik.values.name} />
                    ...
                    <div className="flex flex-wrap mb-2">
                        <div className="w-full px-3 mb-6 md:mb-0">
                            ...
                            onChange={formik.handleChange}
                            onBlur={formik.handleBlur}
                            defaultValue={(currentListing && currentListing.description) ? currentListing.description : formik.values.description}
                    ...
                    <div className="flex flex-wrap mb-2">
                        <div className="w-full px-3">
                            ...
                            onChange={formik.handleChange}
                            onBlur={formik.handleBlur}
                            defaultValue={(currentListing && currentListing.address) ? currentListing.address : formik.values.address}
                    ...
                    <div className="flex flex-row mb-2">
                        <div className="flex flex-col w-1/2 gap-2">
                            ...
                            onChange={formik.handleChange}
                            onBlur={formik.handleBlur}
                            defaultValue={(currentListing && currentListing.bedrooms) ? currentListing.bedrooms : formik.values.bedrooms} 
                        ...
                        <div className="flex flex-col w-1/2 gap-2">
                            ...
                            onChange={formik.handleChange}
                            onBlur={formik.handleBlur}
                            defaultValue={(currentListing && currentListing.bathrooms) ? currentListing.bathrooms : formik.values.bathrooms} 
                            className="rounded-lg appearance-none p-3 w-1/2" />
                        </div>
                    ...
                    <div className="flex flex-col mb-2">
                        ...
                        <div className="flex flex-row gap-6">
                            <div className="flex mb-4 items-center">
                                ...
                                defaultChecked={(currentListing && currentListing.type) ? (currentListing.type === "Rent" ? true : false) : (dealType === "Rent" ? true : false)} 
                                onChange={() => {
                            ...
                            <div className="flex mb-4 items-center">
                                <input type="radio" 
                                defaultChecked={(currentListing && currentListing.type) ? (currentListing.type === "Sell" ? true : false) : (dealType === "Sell" ? true : false)} 
                                onBlur={formik.handleBlur}
                    ...
                    <div className="flex flex-row flex-wrap gap-9">
                        ...
                        <div className="flex items-center mb-4">
                            ...
                            onChange={formik.handleChange}
                            onBlur={formik.handleBlur}
                            checked={(currentListing && currentListing.furnished) ? currentListing.furnished : formik.values.furnished}
                        ...
                        <div className="flex items-center mb-4">
                            ...
                            checked={(currentListing && currentListing.offer) ? currentListing.offer : formik.values.offer} 
                            onBlur={formik.handleBlur}
                            onChange={(e) => {
                    ...
                    <div className="flex flex-wrap -mx-3 mb-2">
                        <div className="w-full px-3">
                            ...
                            <div className="flex">
                                ...
                                onChange={formik.handleChange}
                                onBlur={formik.handleBlur}
                                value={(currentListing && currentListing.regularPrice) ? currentListing.regularPrice : formik.values.regularPrice}
                        ...
                        <div className="flex flex-wrap -mx-3 mb-2">
                            <div className="w-full px-3">
                                ...
                                <div className="flex">
                                    ...
                                    onChange={formik.handleChange}
                                    onBlur={formik.handleBlur}
                                    value={ (currentListing && currentListing.discountPrice) ? currentListing.discountPrice : formik.values.discountPrice}
                                    className="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    {
                        listId ? 
                        <button type="submit" disabled={!(formik.isValid && formik.dirty)} className="rounded-lg p-3 bg-green-700 text-white  disabled:opacity-80 disabled:cursor-not-allowed hover:opacity-50 cursor-pointer">Update List</button>
                        :  <button type="submit" disabled={!(formik.isValid && formik.dirty)} className="rounded-lg p-3 bg-green-700 text-white  disabled:opacity-80 hover:opacity-50 disabled:cursor-not-allowed cursor-pointer">Create List</button>
                    }
